        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td><button class="btn">Excellent</button></td>
                    <td><button class="btn">no.1</button></td>
                    <td>
                    <input type="checkbox" class="ai-checkbox" id="ai-checkbox-1">
                    </td>
                </tr>
                <tr>
                    ...
                    <td><button class="btn">INSTRUCTOR</button></td>
                    <td><button class="btn">-------</button></td>
                    <td><button class="btn">Very Good</button></td>
                    <td><button class="btn">no.2</button></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><button class="btn">-------</button></td>
                    <td><button class="btn">Good</button></td>
                    <td><button class="btn">no.3</button></td>
                    <td>
                        <input type="checkbox" class="ai-checkbox" id="ai-checkbox-2">
                    </td>
                </tr>
