    ...
    <section class="content">
      ...
      <section class="container">
        <div class="section">
          ...
          <div class="content">
            <strong>Complaint Report Requirements:</strong>
            <ul>
              <li><b>Submission Deadline:</b> Within 24 hours of incident or discovery.</li>
              <li><b>Documentation:</b> Include factual details and supporting documents.</li>
              <li><b>Confidentiality Compliance:</b> Handle reports with strict confidentiality, accuracy, and timeliness.</li>
            </ul>
          </div>
        </div>
        <hr>
