...
<div id="sidebar" class="sidebar">
  ...
  <div id="main-content" class="main-content">
    ...
    <section class="content">
      <h2>Special Report Submission</h2>
      <p><Strong>Important Notice: Timely Report Submission</Strong></p>
      <p>Reports must be submitted on time to maintain accuracy and effectiveness, and failure may result in further review and disciplinary actions, requiring timely completion to avoid disruptions and compliance.</p>
      <div class="NR">
        
        <h3 class="highlight">Newest Report</h3>
        ...
        <table>
          ...
          <tbody>
              <tr>
                  <td>HESDYAM</td>
                  <td>HESDYAM@GMAIL.COM</td>
                  <td>0959213123</td>
                  <td>Registrar Staff</td>
                  <td>01-01-2025</td>
                  <td><a href="#" class="download">Download PDF</a></td>
                  <td>
